...
export const project = {
  id: 2,
  title: 'Dreams Built',
  description: 'A sophisticated platform connecting dreamers with resources to build their aspirations into reality.',
  image: featureImage,
  slug: 'dreams-built',
  tags: ['React', 'TypeScript', 'PostgreSQL', 'Node.js', 'Express', 'Railway'],
  status: 'completed',
  priority: 'high',
