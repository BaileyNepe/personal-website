...
export const project = {
  id: 3,
  title: 'Grace & Aroha',
  description: 'A heartfelt website showcasing New Zealand culture and values with beautiful design and storytelling.',
  image: featureImage,
  slug: 'grace-and-aroha',
  tags: ['Next.js', 'Strapi', 'TypeScript', 'PostgreSQL', 'Node.js', 'Express', 'Railway'],
  status: 'completed',
  priority: 'low',
